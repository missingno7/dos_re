...
3DAh retrace waits at ~70 Hz real time), F10 screenshot / F12 snapshot, and
``--snapshot`` resume.  Demo record/replay engines land here as PMRuntime
grows them; the flag surface stays the standard one.
