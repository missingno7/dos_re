...
| [`execution_planner.md`](execution_planner.md) | **dos_re 3.0 launch model:** one planner, hybrid and standalone dependency modes, mixed per-region implementation bindings, runtime-service selection, detachment/readiness reports, thin presets, and atlas-independent coverage interfaces. |
