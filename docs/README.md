...
| [`dos_re_3_0/demo_replay_boundaries.md`](dos_re_3_0/demo_replay_boundaries.md) | **dos_re 3.0 hook-verification workstream:** navigable oracle-versus-hook demos, stable points, base-relative persistent boundaries, complete-state cache identities, function-visit metadata, compatibility, and phased integration. |
