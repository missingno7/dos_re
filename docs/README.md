...
| [`execution_planner.md`](execution_planner.md) | **dos_re 3.0 launch model:** one universal `play.py`, orthogonal composition/execution/verification/build policies, mixed per-region bindings, detachment reports, a closed-world exporter, and atlas-independent coverage/evidence interfaces. |
