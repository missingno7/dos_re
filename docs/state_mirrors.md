...
mechanism described here lives in the game adapter — the framework prescribes
the pattern, not the code. For the terms "island" and "golden" used below, see
the vocabulary in [`lifecycle.md`](lifecycle.md).)*
