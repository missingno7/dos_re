...
| OPL2/OPL3 FM synthesis (actual sound) | modeled | `dos_re/opl3.py` — pure-Python Nuked-OPL3 v1.8 translation, byte-exact vs the upstream reference (tests/test_opl3.py); wired to viewers via `dos_re.audio_sink` |
