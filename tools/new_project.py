...
The 2.0 rule (dos_re/docs/history/dos_re_2.0.md section 3): game-specific knowledge
...
''')
 ...
 "$schema_note": "Structured, evidence-backed, game-specific recovery facts (dos_re/docs/history/dos_re_2.0.md section 3). The pipeline consumes these; generated output never encodes them by hand-edit. Every fact carries provenance (why + evidence + recorded date).",
 "game": "GAME_NAME",
 "keep_interpreted": [],
 "code_as_data": [],
 "notes": []
...
See dos_re/docs/history/dos_re_2.0.md section 1 for the generated-code contract.
""")
...
''')
    ...
    _w(out, "tests/test_layer_dependencies.py", f'''"""Static architectural guardrails (dos_re/docs/history/dos_re_2.0.md section 1a).
